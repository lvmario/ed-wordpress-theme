 ...
 */
namespace Eina\Module\WpCustomization\CPTGenerator;
use Eina\Module\WpCustomization\LabelGenerator as LabelGenerator;
...
function register_the_custom_post_type( $post_type, array $config ) {
	...
	if ( ! $args['labels'] ) {
		$args['labels'] = LabelGenerator\generate_the_custom_labels( $config['labels'] );
	}
